...
2. Keep `FileRecord` temporarily for compatibility
...
## 11.2 Application migration order

### Phase 1

- add shared models and DB schema
...
- add purge worker
- add admin/reindex scripts
- remove obsolete compatibility code

## 11.3 Backward compatibility

During rollout, existing users’ files should appear at root automatically.

No user-visible migration step should be required.
...
### Phase 1: shared models + DB schema
...
### Safer production-quality delivery

Approximately **4–8 weeks** for one engineer depending on test depth, migration caution, and edge-case polish.
...
- [ ] Add DB migration for `folders`
- [ ] Add new `files` columns
- [ ] Add folder repository methods
- [ ] Add item listing endpoint
- [ ] Add breadcrumbs endpoint
...
2. **catalog schema + migrations**
3. **catalog folder APIs**
4. **file upload-to-folder + rename/move/trash/restore**
5. **frontend folder browser**
6. **search/activity generalization**
7. **purge worker**

This order minimizes disruption and lets the team ship value incrementally.
